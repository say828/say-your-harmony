...
**ESCALATION RECOMMENDED**: [specific reason] → Use `oh-my-claude-sisyphus:sisyphus-junior`

Examples:
- "Multi-file change required" → sisyphus-junior
- "Complex refactoring needed" → sisyphus-junior
- "Architectural decision involved" → sisyphus-junior-high
</Escalation_Protocol>
