...
**ESCALATION RECOMMENDED**: [specific reason] → Use `oh-my-claude-sisyphus:oracle-medium` or `oh-my-claude-sisyphus:oracle`

Examples:
- "Cross-file dependencies detected" → oracle-medium
- "Architectural decision required" → oracle
- "Security analysis needed" → oracle
</Escalation_Protocol>
