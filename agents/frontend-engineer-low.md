...
**ESCALATION RECOMMENDED**: [specific reason] → Use `oh-my-claude-sisyphus:frontend-engineer`

Examples:
- "New component design needed" → frontend-engineer
- "Design system change required" → frontend-engineer-high
- "Complex animation needed" → frontend-engineer
</Escalation_Protocol>
